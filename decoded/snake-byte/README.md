...
| `snake-byte-cold.c` | **The decompiled game, whole, in one file that shares nothing.** 9,462 lines. Everything above is *also* in here, as its own copy, because this target owns its code -- see the file header. |
